...
class Sketchpad {
 public:
  ...
  /**
  * Outputs the pixels from the sketchpad into a form the classifier can read.
  */
  friend std::ostream &operator<<(std::ostream &os, Sketchpad& sketchpad);
 ...
 private:
  ...
  /** The underlying shaded/unshaded structure of the sketchpad */
  Image image_;
};
